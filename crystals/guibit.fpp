...
&GID          INTEGER JSP,JFL, JFF,JFP,JS
...
&&GILGID      INTEGER ISP,IFL, IFF, IFP, IS
...
&WXS      INTEGER ISP,IFL, IFF, IFP, IS
...
&GIL     1 %VAL(IFF),%VAL(IFP),%VAL(RUE),%VAL(RUS))
&&GILGID      RETURN
&&GILGID      END
...
&WXS     1 %VAL(IFF),%VAL(IFP),%VAL(RUE),%VAL(RUS))
&WXS      RETURN
&WXS      END
