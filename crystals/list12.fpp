...
6100    CONTINUE
C
        IF (MOD23 .NE. 0) STOP 'MOD23 ERROR IN PRC12'
C----- ANY GROUPS?
C
        IF(NGPDIR .GT. 0) THEN
C
...
C----- SOME TYPE OF SCALE FACTOR
      IF (ISSPRT .EQ. 0) WRITE(NCWU,1550)(SCALE(I,ITYPE),I=1,2),KA
      WRITE(NCAWU,1550)(SCALE(I,ITYPE),I=1,2),KA
      WRITE( CMON ,1550)(SCALE(I,ITYPE),I=1,2),KA
      CALL XPRVDU(NCVDU, 1,0)
...
C----- SOME TYPE OF SPECIAL PARAMETER
      IF (ISSPRT .EQ. 0)
     1 WRITE(NCWU,1570) (SCALE(I,ITYPE),I = 1,2), KA
      WRITE(NCAWU,1570) (SCALE(I,ITYPE),I = 1,2), KA
      WRITE( CMON,1570) (SCALE(I,ITYPE),I = 1,2), KA
      CALL XPRVDU(NCVDU, 1,0)
