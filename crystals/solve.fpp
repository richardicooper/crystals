...
CDJS0102 CHANGE TO WORK ON MAXIMUM VALUE
C---- CHANGE I+3 TO I+5 ETC
4900  CONTINUE
      IF(STORE(K)-STORE(I+5))4950,5050,5050
C--CALCULATE THE NEW SHIFT FACTOR
4950  CONTINUE
CDJW0102--- CHANGE TO ZERO (FROM SQ) TO AVOID
C      MASSIVE SHIFTS IF MAXIMUM SHIFT IS SMALL
      IF(STORE(I+5)-ZERO)5050,5050,5000
5000  CONTINUE
      STORE(I)=STORE(K)/STORE(I+5)
