...
&DVF         READ ( CLINPB(NSTART:NENDIN) , '(F10.0)', ERR = 9940 ) VALU
&DVF       ELSEIF (LFMTXP.EQ.11) THEN
&DVF         READ ( CLINPB(NSTART:NENDIN) , '(F11.0)', ERR = 9940 ) VALU
&DVF       ELSEIF (LFMTXP.EQ.12) THEN
&DVF         READ ( CLINPB(NSTART:NENDIN) , '(F12.0)', ERR = 9940 ) VALU
&DVF       ELSEIF (LFMTXP.EQ.13) THEN
&DVF         READ ( CLINPB(NSTART:NENDIN) , '(F13.0)', ERR = 9940 ) VALU
&DVF       ELSEIF (LFMTXP.EQ.14) THEN
&DVF         READ ( CLINPB(NSTART:NENDIN) , '(F14.0)', ERR = 9940 ) VALU
&DVF       ELSEIF (LFMTXP.EQ.15) THEN
&DVF         READ ( CLINPB(NSTART:NENDIN) , '(F15.0)', ERR = 9940 ) VALU
&DVF       ENDIF
