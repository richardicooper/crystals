...
#DVF         WRITE (CFMTXP, '(''( F'', I2, ''.0)'')') LFMTXP
&DVF       IF (LFMTXP.EQ.1) THEN
&DVF         READ ( CLINPB(NSTART:NENDIN) , '(F1.0)', ERR = 9940 ) VALUE
&DVF       ELSEIF (LFMTXP.EQ.2) THEN
&DVF         READ ( CLINPB(NSTART:NENDIN) , '(F2.0)', ERR = 9940 ) VALUE
&DVF       ELSEIF (LFMTXP.EQ.3) THEN
&DVF         READ ( CLINPB(NSTART:NENDIN) , '(F3.0)', ERR = 9940 ) VALUE
&DVF       ELSEIF (LFMTXP.EQ.4) THEN
&DVF         READ ( CLINPB(NSTART:NENDIN) , '(F4.0)', ERR = 9940 ) VALUE
&DVF       ELSEIF (LFMTXP.EQ.5) THEN
&DVF         READ ( CLINPB(NSTART:NENDIN) , '(F5.0)', ERR = 9940 ) VALUE
&DVF       ELSEIF (LFMTXP.EQ.6) THEN
&DVF         READ ( CLINPB(NSTART:NENDIN) , '(F6.0)', ERR = 9940 ) VALUE
&DVF       ELSEIF (LFMTXP.EQ.7) THEN
&DVF         READ ( CLINPB(NSTART:NENDIN) , '(F7.0)', ERR = 9940 ) VALUE
&DVF       ELSEIF (LFMTXP.EQ.8) THEN
&DVF         READ ( CLINPB(NSTART:NENDIN) , '(F8.0)', ERR = 9940 ) VALUE
&DVF       ELSEIF (LFMTXP.EQ.9) THEN
&DVF         READ ( CLINPB(NSTART:NENDIN) , '(F9.0)', ERR = 9940 ) VALUE
&DVF       ELSEIF (LFMTXP.EQ.10) THEN
&DVF        READ ( CLINPB(NSTART:NENDIN) , '(F10.0)', ERR = 9940 ) VALUE
&DVF       ELSEIF (LFMTXP.EQ.11) THEN
&DVF        READ ( CLINPB(NSTART:NENDIN) , '(F11.0)', ERR = 9940 ) VALUE
&DVF       ELSEIF (LFMTXP.EQ.12) THEN
&DVF        READ ( CLINPB(NSTART:NENDIN) , '(F12.0)', ERR = 9940 ) VALUE
&DVF       ELSEIF (LFMTXP.EQ.13) THEN
&DVF        READ ( CLINPB(NSTART:NENDIN) , '(F13.0)', ERR = 9940 ) VALUE
&DVF       ELSEIF (LFMTXP.EQ.14) THEN
&DVF        READ ( CLINPB(NSTART:NENDIN) , '(F14.0)', ERR = 9940 ) VALUE
&DVF       ELSEIF (LFMTXP.EQ.15) THEN
&DVF        READ ( CLINPB(NSTART:NENDIN) , '(F15.0)', ERR = 9940 ) VALUE
&DVF       ENDIF
#DVF         READ ( CLINPB(NSTART:NENDIN) , CFMTXP , ERR = 9930 ) VALUE
       ELSE IF ( IVALTP .EQ. ITPINT ) THEN
#DVF         WRITE (CFMTXP, '(''( I'',I2,''  )'')') LFMTXP
&DVF       IF (LFMTXP.EQ.1) THEN
&DVF         READ ( CLINPB(NSTART:NENDIN) , '(I1)', ERR = 9940 ) IVALUE
&DVF       ELSEIF (LFMTXP.EQ.2) THEN
&DVF         READ ( CLINPB(NSTART:NENDIN) , '(I2)', ERR = 9940 ) IVALUE
&DVF       ELSEIF (LFMTXP.EQ.3) THEN
&DVF         READ ( CLINPB(NSTART:NENDIN) , '(I3)', ERR = 9940 ) IVALUE
&DVF       ELSEIF (LFMTXP.EQ.4) THEN
&DVF         READ ( CLINPB(NSTART:NENDIN) , '(I4)', ERR = 9940 ) IVALUE
&DVF       ELSEIF (LFMTXP.EQ.5) THEN
&DVF         READ ( CLINPB(NSTART:NENDIN) , '(I5)', ERR = 9940 ) IVALUE
&DVF       ELSEIF (LFMTXP.EQ.6) THEN
&DVF         READ ( CLINPB(NSTART:NENDIN) , '(I6)', ERR = 9940 ) IVALUE
&DVF       ELSEIF (LFMTXP.EQ.7) THEN
&DVF         READ ( CLINPB(NSTART:NENDIN) , '(I7)', ERR = 9940 ) IVALUE
&DVF       ELSEIF (LFMTXP.EQ.8) THEN
&DVF         READ ( CLINPB(NSTART:NENDIN) , '(I8)', ERR = 9940 ) IVALUE
&DVF       ELSEIF (LFMTXP.EQ.9) THEN
&DVF         READ ( CLINPB(NSTART:NENDIN) , '(I9)', ERR = 9940 ) IVALUE
&DVF       ELSEIF (LFMTXP.EQ.10) THEN
&DVF         READ ( CLINPB(NSTART:NENDIN) , '(I10)', ERR = 9940 ) IVALUE
&DVF       ELSEIF (LFMTXP.EQ.11) THEN
&DVF         READ ( CLINPB(NSTART:NENDIN) , '(I11)', ERR = 9940 ) IVALUE
&DVF       ELSEIF (LFMTXP.EQ.12) THEN
&DVF         READ ( CLINPB(NSTART:NENDIN) , '(I12)', ERR = 9940 ) IVALUE
&DVF       ELSEIF (LFMTXP.EQ.13) THEN
&DVF         READ ( CLINPB(NSTART:NENDIN) , '(I13)', ERR = 9940 ) IVALUE
&DVF       ENDIF
#DVF      READ ( CLINPB(NSTART:NENDIN) , CFMTXP, ERR = 9940 ) IVALUE
       ENDIF
C
