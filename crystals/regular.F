...
C    PLATOM(13) CONTAINS THE DETAILS OF THE ATOM IN THE USUAL LIST 5
...
C -- APPLY OFFSET TO COORDINATES
      CALL XSUBTR (TEMP(1),ORIGIN(1),STORE(INDATM+5),3)
C -- COPY COORDINATES TO APPROPRIATE PLACE
      CALL XMOVE (STORE(INDATM+5),STORE(INDNEW),3)
