...
C -- THESE ARE THE COMMON BLOCK OFFSETS LESS 1
      ...
      IMDAT2 = 10
      IMDATM = 11
C -- NOTE - THE 'ATOM' DIRECTIVE REQUIRES A SPACE OF 14 WORDS
      IMDINP = 35
      IMDOUT = 36
...
C-C-C-INTRODUCTION OF ADDITIONAL DIRECTIVE-ADDRESSES FOR "SPECIALS"
      GO TO (  1400 ,  2000 ,  2450 ,  3550 ,  5000 ,
     2  5000 ,  5000 ,  5000 ,  6050 ,  6550 , 6570,
     3  7250 ,  7300 ,  8750 ,  9000 , 10400 ,
     4 12000 ,  1200 , 15100 , 15200 , 15300 ,
     5  15400, 15500, 15510, 8000, 9010, 15600, 6520, 6500, 7500,
     6  7600, 7510, 7520, 7530, 3000, 1320, 19920 ) , IDIRNM
      GO TO 19920
C
1320  CONTINUE
C -- 'MODIFY' DIRECTIVE
