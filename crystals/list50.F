...
C
C Revision 1.4  2001/02/26 10:28:02  richard
...
950   FORMAT ( 80A1 )
      WRITE ( NCWU, 950) (LCMAGE(I),I=1,80 )
C
...
1350  CONTINUE
      ...
      WRITE(NCWU,1300)(ISTORE(J),J=LR52,MR52)
      LR52=LR52+MDR52
1400  CONTINUE
...
C--READ THE NEXT INSTRUCTION NAME
      ...
      WRITE(NCWU,1750)(ISTORE(I+1),I=MR50,J),NR60,NR63,NR64
1750  FORMAT(12A1,3X,3I5)
C--COMPUTE THE MAXIMUM LENGTH FOR THIS NAME
      CALL XMAXCH(ISTORE(MR50),MDR50)
      JRPLCE=1
...
C--LOOP OVER EACH INPUT LOAD DETAIL
      ...
      WRITE(NCWU,1950)ISTORE(MR64),ISTORE(MR64+1),(STORE(I),I=J,K)
...
C--READ THE REQUIRED LISTS
      ...
      WRITE(NCWU,2250)(ISTORE(I),I=MR63,J)
2250  FORMAT(16I5)
...
C--READ THE DIRECTIVE NAME
     ...
     3 JD)
      WRITE(NCWU,2450)K,(ISTORE(I+1),I=MR60,J),ISTORE(MR61+3),
     2 ISTORE(MR61+7),ISTORE(MR61+6),ISTORE(MR61+31),(ISTORE(I),I=JC,
     3 JD)
2450  FORMAT(I4,1X,12A1,3X,10I5)
C--COMPUTE THE MAXIMUM LENGTH FOR THIS NAME
      CALL XMAXCH(ISTORE(MR60),MDR60)
...
C--READ THE CONSTANTS FOR THE TITLE AND FORMATS
      ...
      WRITE(NCWU,3700)(ISTORE(I),ISTORE(I+1),I=JE,JF,JG)
...
C--READ THE EXCLUDED DIRECTIVES
      ...
      WRITE(NCWU,3250)(ISTORE(I),I=J,K)
3250  FORMAT(5X,15I5)
...
C--READ THE INPUT AND STORED PARAMETER TYPES
      ...
      WRITE(NCWU,3700)(ISTORE(I),I=K,L,NWPART)
3700  FORMAT(5X,15I5)
...
4100  CONTINUE
     ...
     2 ISTORE(L+9),ISTORE(L+3),ISTORE(L+6),IICHAR
      WRITE(NCWU,4150)(ISTORE(I+1),I=J,K),ISTORE(L+4),ISTORE(L+7),
     2 ISTORE(L+9),ISTORE(L+3),ISTORE(L+6),IICHAR
...
4200  CONTINUE
     ...
     2 ISTORE(L+9),ISTORE(L+3),ISTORE(L+6),STORE(L+8)
      WRITE(NCWU,4250)(ISTORE(I+1),I=J,K),ISTORE(L+4),ISTORE(L+7),
     2 ISTORE(L+9),ISTORE(L+3),ISTORE(L+6),STORE(L+8)
...
4300  CONTINUE
     ...
     2 ISTORE(L+9),ISTORE(L+3),ISTORE(L+6),ISTORE(L+8)
      WRITE(NCWU,4350)(ISTORE(I+1),I=J,K),ISTORE(L+4),ISTORE(L+7),
     2 ISTORE(L+9),ISTORE(L+3),ISTORE(L+6),ISTORE(L+8)
4350  FORMAT(5X,12A1,3X,5I5,I10)
C--COMPUTE THE MAXIMUM LENGTH FOR THIS KEYWORD
4400  CONTINUE
      CALL XMAXCH(ISTORE(J),NWPAR)
...
5200  CONTINUE
      ...
      WRITE(NCWU,5250)(ISTORE(I+1),I=M,N)
...
C--LOOP OVER EACH VALUE, SETTING THE MAXIMUM LENGTH
      N=ISTORE(L+3)
      DO 5300 I=1,N
      CALL XMAXCH(ISTORE(M),ISTORE(L+2))
      M=M+ISTORE(L+2)
5300  CONTINUE
      GOTO 5650
...
5550  CONTINUE
      ...
      WRITE(NCWU,5600)(ISTORE(I),I=M,N)
5600  FORMAT(5X,7I10)
