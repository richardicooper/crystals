...
C Revision 1.32  2011/09/19 09:27:46  rich
C Punch of List 31.
C
C Revision 1.31  2011/09/19 09:02:31  rich
C Punch of L29.
C
C Revision 1.30  2011/09/16 14:43:58  rich
C Punching of list 28.
C
C Revision 1.29  2011/09/16 12:41:42  rich
C Punching of List 25.
C
C Revision 1.28  2011/09/16 12:24:03  rich
C Punching of List 23.
C
C Revision 1.27  2011/09/16 10:57:38  rich
...
c----- check for LIST 1 for Ndave
      if(lstno.eq.1) then
            ...
            call XPCH13
            return
      else if(lstno.eq.23) then   !check for LIST 23
            call XPCH23
            return
      else if(lstno.eq.25) then   !check for LIST 25
            call XPCH25
            return
      else if(lstno.eq.28) then   !check for LIST 28
            call XPCH28
            return
      else if(lstno.eq.29) then   !check for LIST 29
            call XPCH29
            return
      else if(lstno.eq.31) then   !check for LIST 31
            call XPCH31
            return
      else if(lstno.eq.39) then   !check for LIST 39
            call XPCH39
            return
      endif
c
...
7320  CONTINUE
      CALL XPCH5X
      RETURN
C-- 5C CAMBRIDGE FORMAT
7330  CONTINUE
cdjwapr2010      CALL XPCH5C(0)
      CALL XPCH5C(1)
      RETURN
C-- 5D 'CHIME' XYZ FORMAT
7340  CONTINUE
      CALL XPCH5D
      RETURN
