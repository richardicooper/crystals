...
&&DVFGID      CALL PERROR (' perror message ')
...
C    TO ALWAYS RETURN THE VALUE 0.0 FROM THIS ROUTINE, EXCEPT THAT THE
C    MESSAGES WILL NO LONGER BE APPROPRIATE. NOTE THAT THE VARIABLE
...
&&DVFGID      STOP 'ROUTINE NOT IMPLEMENTED'
...
C----- INITIALISE THE WINDOWS ENVIRONMENT
C      IN - RETURNED AS 0 IF INITIALISATION FAILS
\XSSVAL
\XGUIOV
\XUNITS
C LGUIL1 IS SET IF LIST 1 IS AVAILABLE
C LGUIL5 IS SET IF LIST 5 IS AVAILABLE
C LUPDAT IS SET WHEN GUMTRX IS INITIALISED AND GUI IS ENABLED
      IN = 0
