module xrtlsc_mod
!C----- BEWARE - SOME SQUALID EQUIVALENCING USED IN SUBROUTINES.
...
COMMON /RDD/CF, CO, AO, UO, AL, AT, AS
COMMON /RWORK/WA, WB, WC, WD, AA, AB
COMMON /REE/DV, AI, AR
COMMON /RDSTC/AQ, DL,DA,IPRINT,TESTEV,TESTER,JDEL, NDEL
COMMON /TLSSAV/ SAVET, SAVEL, SAVES, SAVEE, SAVEC
