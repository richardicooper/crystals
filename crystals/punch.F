...
1000  FORMAT('READ NCOEFFICIENT = 11, TYPE = FIXED, UNIT = DATAFILE' ,
     ...
     5 / 'END')
c
1001  FORMAT('READ NCOEFFICIENT = 10, TYPE = FIXED, UNIT = DATAFILE' ,
     1 ', CHECK=NO' /
     2 'INPUT H K L /FO/ SIGMA(/FO/) /FC/ PHASE RATIO  ELEMENTS'
     4 ,' SQRTW' /
     3 'FORMAT (3F4.0,F10.2,F8.2,F10.2,F8.4,F 6.2,F10.2,F3.0,G12.5)'
     5 / 'END')
C<DJW280896
...
1200  FORMAT(3I4,F10.2,F8.2,F10.2,F8.4,F6.2,F10.2,I3,G12.5)
     ...
     2 STORE(M6+5),STORE(M6+6),STORE(M6+20),ISTORE(M6+11),
     3 STORE(M6+4)
1201  FORMAT(3I4,F10.2,F8.2,F10.2,F8.4,F6.2,10X,I3,G12.5)
