...
\XSSVAL
\XCONST
      COMMON /XMRG/WORK(30),ISTAT(100), RINT(6), RINTF(300)
...
4104  FORMAT(
     ...
     2 2X,F18.3, F16.3, F15.3)
      ...
      DO I = 1,100
        ...
        WRITE (NCFPU1,'(F4.1,3X,F15.7,3X,I7)')
     1     (I-1)/2.0, RINTF(I)*100., NINT(RINTF(I+200))
      END DO
      I = KFLCLS(NCFPU1)
C
...
C----- COMPUTE TOTALS FOR FINER GRAINED RINT
     ...
     1           JRINTF = 1+ NINT(2.*STORE(JFO)/STORE(JREF+12))
      ...
      IF ( JRINTF .EQ. 1 ) THEN
        WRITE (NCWU,'(''FO, DELTA'',2F15.6)')STORE(JFO),ABS(WORK(7))
      END IF
