...
&&GIDGIL      CHARACTER*80 CHARTC
&&GIDGIL      WRITE(CHARTC,1)'^^CH CLEAR'
&&GIDGIL1     FORMAT (A)
&&GIDGIL      CALL ZMORE(CHARTC,0)
&&GIDGIL      WRITE(CHARTC,2)'^^CH RGB',
&&GIDGIL     1 NINT(4.04*IVGACL(1,ICOL+1)),
&&GIDGIL     2 NINT(4.04*IVGACL(2,ICOL+1)),
&&GIDGIL     3 NINT(4.04*IVGACL(3,ICOL+1))
&&GIDGIL2     FORMAT (A,3(1X,I3))
&&GIDGIL      CALL ZMORE(CHARTC,0)
&&GIDGIL      WRITE(CHARTC,3)'^^CH POLYF 4',IX1,IY1,IX1,IY2,
&&GIDGIL     1  IX2,IY2,IX2,IY1
&&GIDGIL3     FORMAT(A,8(1X,I5))
&&GIDGIL      CALL ZMORE(CHARTC,0)
      RETURN
      END
...
&&GILGID      WRITE(CHARTC,2)'^^CH RGB',
&&GILGID     1 NINT(4.04*IVGACL(1,ICOL+1)),
&&GILGID     2 NINT(4.04*IVGACL(2,ICOL+1)),
&&GILGID     3 NINT(4.04*IVGACL(3,ICOL+1))
&&GILGID2     FORMAT (A,3(1X,I3))
&&GILGID      CALL ZMORE(CHARTC,0)
&&GILGID      WRITE(CHARTC,3)'^^CH LINE',IX1,IY1,IX2,IY2
&&GILGID3     FORMAT(A,4(1X,I4))
&&GILGID      CALL ZMORE(CHARTC,0)
...
&&GILGID2     FORMAT (A,3(1X,I3))
&&GILGID      CALL ZMORE(CHARTC,0)
&&GILGID      WRITE(CHARTC,3)'^^CH TEXT',IX,IY,'''',
&&GILGID     1 TEXT(1:LEN(TEXT)),''''
&&GILGID3     FORMAT(A,1X,2(I4,1X),3A)
&&GILGID      CALL ZMORE(CHARTC,0)
...
&&GILGID2     FORMAT (A,3(1X,I3))
&&GILGID      CALL ZMORE(CHARTC,0)
&&GILGID      WRITE(CHARTC,3)'^^CH ELLIF',IXC,IYC,IMAJ,IMIN
&&GILGID3     FORMAT(A,4(1X,I4))
&&GILGID      CALL ZMORE(CHARTC,0)
      RETURN
      END
...
&&GILGID      ID = KQUICKDATA(N*2)    

      DO 10 I = 1 , N

&DOS        ixx2(i) = nint(float(ix(i))*scale_X)
&DOS        iyy2(i) = nint(float(iy(i))*scale_Y)
&&GILGID        CALL ADDDATA(ID,IX(I))
&&GILGID        CALL ADDDATA(ID,IY(I))
...
&&GILGID2     FORMAT (A,3(1X,I3))
&&GILGID      CALL ZMORE(CHARTC,0)
&&GILGID      WRITE(CHARTC,3)'^^CH FPOLYE',N,ID
&&GILGID3     FORMAT(A,2(1X,I6))
&&GILGID      CALL ZMORE(CHARTC,0)
...
&&GILGID2     FORMAT (A,3(1X,I3))
&&GILGID      CALL ZMORE(CHARTC,0)
&&GILGID      WRITE(CHARTC,3)'^^CH ELLIE',IXC,IYC,IMAJ,IMIN
&&GILGID3     FORMAT(A,4(1X,I4))
&&GILGID      CALL ZMORE(CHARTC,0)
      RETURN
      END
...
&&GILGID2     FORMAT (A,3(1X,I3))
&&GILGID      CALL ZMORE(CHARTC,0)
&&GILGID      WRITE(CHARTC,3)'^^CH FPOLYF',N,ID
&&GILGID3     FORMAT(A,2(1X,I6))
&&GILGID      CALL ZMORE(CHARTC,0)
...
&&GILGID      SUBROUTINE ADDDATA(ID, IDATA)
&GID      INTERFACE
...
&GID      END INTERFACE
&&GILGID      INTEGER ID, IDATA
&&GILGID      CALL DATAIN(ID, IDATA)
&&GILGID      RETURN
&&GILGID      END
