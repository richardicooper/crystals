...
C &&GIDGIL     1 NINT(4.04*IVGACL(1,ICOL+1)),
C &&GIDGIL     2 NINT(4.04*IVGACL(2,ICOL+1)),
C &&GIDGIL     3 NINT(4.04*IVGACL(3,ICOL+1))
...
C &&GILGID     1 NINT(4.04*IVGACL(1,ICOL+1)),
C &&GILGID     2 NINT(4.04*IVGACL(2,ICOL+1)),
C &&GILGID     3 NINT(4.04*IVGACL(3,ICOL+1))
...
&&GILGID      CHARACTER*80 CTEXT
&&GILGID      CALL FASTTEXT(IX, IY, CTEXT)
&&GILGID      RETURN
&&GILGID      END
