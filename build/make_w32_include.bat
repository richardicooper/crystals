...
@set FDEF=-D__INW__ -DCRY_GUI -DCRY_USEWX -DCRY_OSWIN32 -DCRY_FORTINTEL  /I..\hdf5\include
@rem @set LD=xilink
@set LD=ifort
@set OUT=/exe:
@set OPT=/O2 /Zi
