...
%F77% /fpp %FDEF% /I..\crystals /I..\bits\cif2cry ..\bits\cif2cry\cif2cry.fpp /optimize:4 /MD
...
%F77% /fpp /define:_%COMPCODE%_ /I..\crystals /I..\bits\foxman ..\bits\foxman\pcf2cry.fpp /optimize:4 /MD
%F77% /fpp /define:_%COMPCODE%_ /I..\crystals /I..\bits\kccdin ..\bits\kccdin\kccdin.fpp /optimize:4 /MD
%F77% /fpp /define:_%COMPCODE%_ /I..\crystals /I..\bits\OxDiff ..\bits\OxDiff\OxDiffin.fpp /optimize:4 /MD
%F77% /fpp /define:_%COMPCODE%_ /I..\crystals /I..\bits\Diffractometers\ ..\bits\Diffractometers\diffin.fpp /optimize:4 /MD
%F77% /fpp /define:_%COMPCODE%_ /I..\crystals /I ..\bits\rc93 ..\bits\rc93\rc93.fpp  /automatic /optimize:4 /MD
